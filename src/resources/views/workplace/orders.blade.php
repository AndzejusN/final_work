            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div style="height: 500px; overflow-y: scroll;"
                            ...
                            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                                @if(isset($inquiries))
                                    @foreach($inquiries as $inquiry)
                                        <form action="{{ route ('workplace.byorder', ['id' => $inquiry->id]) }}"
                                              class="card-body p-1 text-center"
                                              method="GET">
                                            @csrf
                                            <div class="d-flex row justify-content-between main-input"
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th rowspan="2">
                                                            <button
                                                                class="btn btn-dark text-center align-items-center main-submit"
                                                                type="submit">
                                                                O P E N | O R D E R
                                                            </button>
                                                        </th>
                            ...
                            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                                ...
                                @if(isset($products))
                                    @foreach($products as $product)
                                        <form method="GET"
                                              action="{{ route ('workplace.ordered', ['id' => $product->id]) }}"
                                              class="py-1">
                                            @csrf
                                            ...
                                            <div class="card shadow-2-strong main-input" style="border-radius: 1rem;">
                                                <div class="card-body p-3 text-start">
                                                    ...
                                                    <div class="form-outline py-1">
                                                        <label class="form-label" for="delivery_term">Delivery
                                                            term:</label>
                                                    ...
                                                    <div class="form-outline py-1">
                                                        ...
                                                        <textarea class="form-control" style="min-width: 100%"
                                                                  id="description" name="conditions"
                        ...
                        @else
                            Sorry, you do not have permission to confirm Order.
                        @endif
                    </div>
                </div>
            </div>
