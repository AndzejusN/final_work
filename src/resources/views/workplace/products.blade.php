        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="row d-flex justify-content-start align-items-center h-50">
                            ...
                            <form method="POST" action="{{ route('workplace.create') }}">
                                ...
                                <div class="card shadow-2-strong" style="border-radius: 1rem;" id="main-input">
                                    <div class="card-body p-3 text-start">
                                        ...
                                        <div class="form-outline py-1">
                                            <label for="description" :value="__('Description')">Product description:</label>
                                            <textarea class="form-control" style="min-width: 100%" id="description"
                                                      name="description" :value="old('description')"></textarea>
                                        </div>
                                        <div class="form-outline py-1">
                                            <label for="measure">Measurement:</label>
                                            <select class="form-control" style="min-width: 100%" id="measure" name="measure">
                                        ...
                                        <div class="form-outline py-1">
                                            <label class="form-label" for="quantity" :value="__('Quantity')">Quantity:</label>
                                            <input type="number" name="quantity" id="quantity"
                                                   class="form-control form-control-sm" :value="old('quantity')" required autofocus/>
                                        </div>
                                        <div class="text-center pt-4">
                                            <button style="min-width: 100%" class="btn btn-dark text-center" type="submit" id="main-submit">
                                                A D D | P R O D U C T
                                            </button>
                                        </div>
                                    </div>
