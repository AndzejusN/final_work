                        ...
                        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                            @if(isset($inquiries))
                                @foreach($inquiries as $inquiry)
                                    <form action="{{ route ('workplace.all', ['id' => $inquiry->id]) }}"
                                          class="card-body p-1 text-center"
                                          method="GET">
                                        @csrf
                                        <div class="d-flex row justify-content-between" style="border-radius: 1rem; font-size:smaller;"
                                             id="main-input">
                                            <table>
                                                <tbody>
                                                <tr>
                        ...
                        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                            @if(isset($products))
                                @foreach($products as $product)
                                    <div class="py-1">
                                        <div class="card shadow-2-strong" style="border-radius: 1rem; font-size:smaller;" id="main-input">
